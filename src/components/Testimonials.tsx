          ...
          <AnimatePresence mode="popLayout">
            {testimonials.length === 0 ? (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="col-span-full text-center py-12 px-6 rounded-3xl border border-dashed border-slate-300 bg-slate-50/50"
              >
                <p className="text-slate-500 font-light italic text-sm">
                  No testimonials published yet. Partnered with us? Be the first to share your experience below!
                </p>
              </motion.div>
            ) : (
